...
from ..exceptions import FormatException, InvalidKeyException
from ..flags import Flags, ModifierKeys
from ..structures.extra_data import ExtraData, ExtraData_EnvironmentVariableDataBlock
from ..structures.id_list.id_list import LinkTargetIDList
from ..structures.link_info import DRIVE_UNKNOWN, LinkInfo
from ..utils.data import convert_time_to_unix, convert_time_to_windows
